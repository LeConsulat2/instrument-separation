...
# Step 1 - Separate the audio into different stems using Demucs
def separate_audio(input_file, output_folder):
    # Run Demucs with its best model for separation
    os.system(f'demucs --two-stems=other "{input_file}" -o "{output_folder}"')
